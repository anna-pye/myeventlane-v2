...
namespace Drupal\myeventlane_reporting\Access;
...
/**
 * Access check for vendor reporting routes.
 */
final class VendorReportingAccess {

  /**
   * Checks access for vendor reporting routes.
   *
